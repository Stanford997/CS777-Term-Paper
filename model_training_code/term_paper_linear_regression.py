...
def train_linear_regression_on_whole_dataset(X, y, model_save_path):
    clf = LinearRegression()
    clf.fit(X, y)
    joblib.dump(clf, model_save_path)
    print(f'Model saved to: {model_save_path}')
...
for ticker in tickers:
    ...
    model_save_path = f'LinearRegression_{ticker}.pkl'
    train_linear_regression_on_whole_dataset(X, y, model_save_path)
